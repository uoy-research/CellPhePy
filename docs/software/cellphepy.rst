...
An example dataset to demonstrate CellPhe’s capabilities is hosted on `Dryad <https://doi.org/10.5061/dryad.4xgxd25f0>`_ in the archive ``example_data.zip`` and comprises 3 parts:
...
For the latter 2, refer to the `CellPose docs <https://cellpose.readthedocs.io/en/latest/models.html>`_ for a full list of options.
